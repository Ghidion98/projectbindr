export default {
    ...
    content: {
        ...
        sortHelp: 'כדי למיין את המסמכים, פשוט יש לגרור את המסמכים או ללחוץ על אחד מכותרות העמודות. ניתן לבחור מספר מסמכים בו זמנית על ידי לחיצת "Shift" או "Ctrl" בזמן הבחירה.',
    ...
    defaultdialogs: {
        ...
        siterepublished: 'זיכרון המטמון של האתר רוענן בהצלחה. כל התוכן המפורסם כעת מעודכן, שאר התוכן המיועד לפירסום ימתין לפירסום',
        siterepublishHelp: 'זיכרון המטמון של האתר ירוענן. כל התוכן שפורסם ירוענן בהתאם, שאר התוכן המיועד לפירסום ימתין לפירסום',
    ...
    dictionaryItem: {
        description: 'ערוך את גרסאות השפות השונות לפריט המילון \'%0%\' למטה ניתן להוסיף שפות נוספות תחת "שפות" בתפריט בצד שמאל',
    ...
    errorHandling: {
        ...
        errorChangingProviderPassword: 'ספק החברות הנוכחית לא תומך בשינוי סיסמה (EnablePasswordRetrieval צריך להיות מוגדר על true)',
        errorExistsWithoutTab: 'השדה %0% כבר קיים',
        errorHeader: 'התרחשו שגיאות:',
        errorHeaderWithoutTab: 'התרחשו שגיאות:',
        errorInPasswordFormat: 'הסיסמה חייבת להיות במינימום של %0% תווים characters long and contain at least %1% non-alpha numeric character(s)',
    ...
    errors: {
        codemirroriewarning: 'שים לב! למרות ש- CodeMirror מופעל מההגדרות, הוא נמצא במצב כבוי באינטרנט אקספלורר מפאת חוסר יציבות.',
    ...
    packager: {
        ...
        packageUninstallText: 'ניתן להוריד סימון מפריטים שאותם אינך רוצה להסיר, בזמן זה. כשילחץ כפתור "אשר הסרה" כל הפריטים המסומנים ימחקו.<br />\n      <span style="color: Red; font-weight: bold;">הערה:</span>כל מסמך, מדיה וכו\' התלוים בפריטים שהסרת יפסיקו לעבוד, ויכולים להביא למצב של אי יציבות למערכת,\n      יש למחוק קבצים עם זהירות יתרה, אם יש ספק יש לפנות ליוצר החבילה.',
        packageVersion: 'גירסת החבילה',
    },
    paste: {
        doNothing: 'שמור עיצוב בהדבקה (לא מומלץ)',
        errorMessage: 'הטקסט שאתה עומד להדביק מכיל עיצוב או תווים מיוחדים. דבר זה יגול להגרם בעת העתקה ממסמך בוורד. אומברקו יכולה להסיר את העיצוב או תווים מיוחדים על מנת שהטקסט המועתק יתאים ל- Web.',
        removeAll: 'הסר עיצוב באופן מלא בהדבקה',
        removeSpecialFormattering: 'הדבק אך הסר רק עיצוב (מומלץ)',
    },
    publicAccess: {
        paAdvanced: 'תפקיד בסיסי בהגנה',
        paAdvancedHelp: 'אם הינך רוצה לשלוט בגישה לעמוד על ידי זיהוי תפקיד המשתמש,<br /> על ידי שימוש בקבוצות הקיימות ב Umbraco.',
    ...
    rollback: {
        diffHelp: 'להלן ההבדלים בין הגירסא הנוכחית לבין הגרסא שנבחרה. <br />טקסט <del>אדום</del> לא יוצג בגרסא שנבחרה, טקסט <ins>ירוק</ins> מייצט טקסט שנוסף.',
    ...
    settings: {
        ...
        importDocumentTypeHelp: "על מנת לייבא סוג מסמך,מצא את הקובץ \".udt\" במחשב שלך על ידי לחיצה על 'סייר' ואז 'ייבא' (ייתכן ותצטרך לבצע אימות במסך הבא)",
    ...
    sort: {
        ...
        sortHelp: 'יש לגרור את הפריטים מעלה או מטה כדי להגדיר את סדר התוכן. או לחץ על כותרת העמודה כדי למיין את כל פריטי התוכן',
    ...
    translation: {
        ...
        translationDoneHelp: 'ניתן לראות תצוגה מקדימה של העמודים שכבר תורגמו על ידי לחיצה על הלינק למטה. If the original page is found, you will get a comparison of the 2 pages.',
