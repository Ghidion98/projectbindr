export default {
    ...
    content: {
        ...
        publishDescendantsHelp: 'Publish <strong>%0%</strong> and all content items underneath and thereby making their content publicly available.',
    ...
    defaultdialogs: {
        ...
        confirmTrash: (name) => `Are you sure you want to move <strong>${name}</strong> to the Recycle Bin?`,
        confirmBulkTrash: (total) => `Are you sure you want to move <strong>${total} ${total === 1 ? 'item' : 'items'}</strong> to the Recycle Bin?`,
        confirmBulkDelete: (total) => `Are you sure you want to delete <strong>${total} ${total === 1 ? 'item' : 'items'}</strong>?`,
        cut: 'Cut',
        ...
        linkYourConfirm: 'You are about to link your Umbraco and {0} accounts and you will be redirected to {0} to confirm.',
    ...
    errors: {
        ...
        externalLoginFailed: 'The server failed to authorize you against the external login provider. Please close the window and try again.',
    ...
    installer: {
        ...
        theEndInstallSuccess: 'You can get <strong>started instantly</strong> by clicking the "Launch Umbraco" button below. <br />If you are <strong>new to Umbraco</strong>,\nyou can find plenty of resources on our getting started pages.',
    ...
    packager: {
        ...
        noPackagesDescription: "Browse through the available packages using the <strong>'Packages'</strong> icon in the top right of your screen",
    ...
    rollback: {
        ...
        diffHelp: 'This shows the differences between the current (draft) version and the selected version<br /><del>Red text</del> will be removed in the selected version, <ins>green text</ins> will be added',
    ...
    contentTypeEditor: {
        ...
        historyCleanupGloballyDisabled: '<strong>NOTE!</strong> The cleanup of historically content versions are disabled globally. These settings will not take effect before it is enabled.',
    ...
    user: {
        ...
        passwordIsDifferent: 'There was a difference between the new password and the confirmed password. Please try again!',
    ...
    healthcheck: {
        ...
        smtpMailSettingsHostNotConfigured: 'In the Web.config file system.net/mailsettings section, the host is\n      not configured.\n    ',
    ...
    welcomeDashboard: {
        ...
        ourUmbracoDescription: "Our Umbraco, the official community site, is your one-stop-shop for everything Umbraco. Whether you need a question answered, cool plugins, or a guide of how to do something in Umbraco, the world's best and friendliest community is just a click away.",
    ...
    blockEditor: {
        ...
        gridInlineEditingHelp: 'Enables inline editing for the first Property. Additional properties can be edited in the overlay.',
        ...
        createThisFor: (name, variantName) => variantName ? `Create ${name} for ${variantName}` : `Create ${name}`,
        ...
        unsupportedBlockDescription: 'This content is no longer supported in this Editor. If you are missing this content, please contact your administrator. Otherwise delete it.',
    },
    ...
    linkPicker: {
        modalSource: 'Source',
        modalManual: 'Manual',
        modalAnchorValidationMessage: 'Please enter an anchor or querystring, or select a published document or media item, or manually configure the URL.',
