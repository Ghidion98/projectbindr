export default {
    ...
    content: {
        ...
        sortHelp: "Para classificar os nós simplesmente arraste os nós ou clique em um dos títulos de colunas. Você pode selecionar múltiplos nós ao pressionar e segurar 'shift' ou 'control' durante a seleção",
    ...
    defaultdialogs: {
        ...
        recycleBinDeleting: 'Os itens na lixeira agora estão sendo removidos. Favor não fechar esta janela enquanto este processo é concluído',
        ...
        regexSearchError: "O serviço web <a target='_blank' rel='noopener' href='http://regexlib.com'>regexlib.com</a> está no momento sofrendo dificuldades dos quais não temos controle. Pedimos desculpas pela inconveniência.",
        regexSearchHelp: "Busque por uma expressão regular para adicionar validação à um campo de formulário. Exemplo: 'email', 'zip-code' (código postal), 'URL'",
        removeMacro: 'Remover Macro',
        requiredField: 'Campo obrigatório',
        sitereindexed: 'Site foi re-indexado',
        siterepublished: 'O cache do website foi atualizado. Todo conteúdo publicado está atualizado agora. No entanto, todo conteúdo não publicado ainda permanecerá invisível',
        siterepublishHelp: 'O cache do website será atualizado. Todo conteúdo publicado será atualizado, enquanto o conteúdo que não foi publicado permanecerá invisível',
    ...
    dictionaryItem: {
        description: "Editar as diferente versões de linguagem para o item de dicionário '%0%' abaixo. Você pode adicionar mais linguagens sob 'linguagens' no menu à esquerda.",
    ...
    errorHandling: {
        errorButDataWasSaved: 'Seus dados foram salvos mas antes que possa publicar esta página existem alguns erros que precisam ser concertados:',
        errorChangingProviderPassword: 'O provedor de membros (Membership provider) atual não suporta alterações de senha (EnablePasswordRetrieval tem que estar definica como true)',
        errorExistsWithoutTab: '%0% já existe',
        errorHeader: 'Houve erros:',
        errorHeaderWithoutTab: 'Houve erros:',
        errorInPasswordFormat: 'A senha deve ter no mínimo %0% caracteres e conter pelo menos %1% caractere(s) não alfa-númérico',
    ...
    errors: {
        codemirroriewarning: 'NOTA! Mesmo que CodeMirror esteja habilitado pela configuração o mesmo foi desabilitado em Internet Explorer pois não é estável o suficiente.',
        ...
        pictureResizeBiggerThanOrg: 'Você está prestes a tornar esta figura maior que o tamanho original. Tem certeza que deseja proceguir?',
    ...
    installer: {
        ...
        databaseInstallDone: 'Umbraco %0% agora foi copiado para seu banco de dados. Pressione <strong>Próximo</strong> para prosseguir.',
        databaseText: 'Para completar este passo, você deve saber algumas informações relativas ao seu servidor de banco de dados ("connection string"). <br /> Favor contatar seu provedor de internet ou hospedagem web se necessário. Se você estiver instalando em uma máquina ou servidor local é possível que você precise dessas informações por um administrador de sistema.',
        ...
        databaseUpgradeDone: 'Seu banco de dados foi atualizado para última versão %0%. <br />Pressione <strong>Próximo</strong> para prosseguir.',
        databaseUpToDate: 'Seu banco de dados atual está desatualizado! Clique <strong>próximo</strong> para continuar com o assistente de configuração',
        defaultUserChangePass: '<strong>A senha do usuário padrão precisa ser alterada!</strong>',
        defaultUserDisabled: '<strong>O usuário padrão foi desabilitado ou não tem acesso à Umbraco!</strong></p><p>Nenhuma ação posterior precisa ser tomada. Clique <strong>Próximo</strong> para prosseguir.',
        defaultUserPassChanged: '<strong>A senha do usuário padrão foi alterada com sucesso desde a instalação!</strong></p><p>Nenhuma ação posterior é necessária. Clique <strong>Próximo</strong> para prosseguir.',
        ...
        permissionsAffectedFoldersText: 'Você precisa conceder permissão de modificação ASP.NET aos seguintes arquivos/pastas',
        permissionsAlmostPerfect: '<strong>Suas permissões estão quase perfeitas!</strong><br /><br />\nVocê pode correr Umbraco sem problemas, mas não vai ser capaz de instalar pacotes que são recomendados para tirar total vantagem de Umbraco.',
        permissionsHowtoResolve: 'Como Resolver',
        permissionsHowtoResolveLink: 'Clique aqui para ler a versão texto',
        permissionsHowtoResolveText: 'Assista nosso <strong>vídeo tutorial</strong> sobre configuração de permissões de pastas para Umbraco ou leia a versão texto.',
        permissionsMaybeAnIssue: '<strong>Suas permissões podem ser um problema!</strong>\n<br/><br/>\nVocê pode correr Umbraco sem problemas mas não será capaz de criar pastas ou instalar pacotes que são recomendados para tirar total vantagem de Umbraco.',
        permissionsNotReady: '<strong>Suas permissões não estão prontas para Umbraco!</strong>\n<br /><br />\nPara correr Umbraco você vai precisar atualizar as configurações de permissões.',
        permissionsPerfect: '<strong>Suas configurações de permissões estão perfeitas!</strong> <br /><br /> Você está pronto para correr o Umbraco e instalar pacotes!',
        permissionsResolveFolderIssues: 'Resolvendo problemas de pastas',
        permissionsResolveFolderIssuesLink: 'Siga este link para mais informações sobre problemas com ASP.NET e criação de pastas',
        permissionsSettingUpPermissions: 'Configurando permissões de pastas',
        permissionsText: 'Umbraco necessita acesso ler/escrever à certos diretórios para que possa guardar arquivos como fotos e PDFs.\nTambém guarda informações temporárias (cache) para melhorar a performance do seu website.',
        runwayFromScratch: 'Eu quero começar do zero',
        runwayFromScratchText: 'Seu site está completamente vazio no momento, então isso é perfeito se você deseja começar do zero e criar seus próprios documentos e modelos.\n        (<a href="https://umbraco.tv/documentation/videos/for-site-builders/foundation/document-types">learn how</a>)\n        Você ainda pode escolher instalar Runway mais tarde. Favor ir à seção Desenvolvedor e selecione pacotes.',
    ...
    moveOrCopy: {
        ...
        notValid: "TRANSLATE ME: 'The action isn't allowed since you have insufficient permissions on 1 or more child documents.'",
    },
    notifications: {
    ...
    packager: {
        chooseLocalPackageText: 'Selecione o pacote em sua máquina clicando no botão Navegar <br /> e localizando o pacote. Pacotes Umbraco tem extensão ".umb" ou ".zip".',
        packageAuthor: 'Autor',
        ...
        packageNoItemsText: 'Este arquivo de pacote não contém nenhum item a ser desinstalado. <br /><br />\nVocê pode remover com segurança do seu sistema clicando em "desinstalar pacote" abaixo.',
        ...
        packageUninstallText: 'Você pode de-selecionar itens que não deseja remover neste momento, abaixo. Quando clicar em "confirmar desinstalação" todos os itens selecionados serão removido. <br />\n<span style="color: Red; font-weight: bold;">Aviso:</span> quaisquer documentos, mídia, etc dependentes dos itens que forem removidos vão parar de funcionar e podem levar à instabilidade do sistema. Então desinstale com cuidado. Se tiver dúvidas, contate o autor do pacote',
        packageVersion: 'Versão do pacote',
    },
    paste: {
        doNothing: 'Colar com formatação completa (Não recomendado)',
        errorMessage: 'O texto que você está tentando colar contém caracteres ou formatação especial. Isto pode ser causado ao copiar textos diretamente do Microsoft Word. Umbraco pode remover os caracteres ou formatação especial automaticamente para que o conteúdo colado seja mais adequado para a internet.',
    ...
    publicAccess: {
        ...
        paAdvancedHelp: 'Se você deseja controlar o acesso à página usando autenticação baseada em funções, <br /> usando grupos de membros do Umbraco.',
        paAdvancedNoGroups: 'Você precisa criar um grupo de membros antes que possa usar <br /> autenticação baseada em função.',
    ...
    publish: {
        ...
        publishHelp: 'Clique em <em>ok</em> para publicar <strong>%0%</strong> e assim fazer com que seu conteúdo se torne disponível. <br /><br />\nVocê pode publicar esta página e todas suas sub-páginas ao selecionar <em>publicar todos filhos</em> abaixo.',
    },
    relatedlinks: {
    ...
    rollback: {
        diffHelp: 'Isto mostra as diferenças entre a versão atual e a versão selecionada <br />Texto <del>vermelho</del> não será mostrado na versão selecionada; <ins>verde significa adicionado</ins>',
        documentRolledBack: 'Documento foi revertido',
        htmlHelp: 'Isto mostra a versão selecionada como html se você deseja ver as diferenças entre as 2 versões ao mesmo tempo use a visão em diff',
    ...
    settings: {
        ...
        importDocumentTypeHelp: 'Para importar um tipo de documento encontre o arquivo ".udt" em seu computador clicando em "Navegar" e depois clicando em "Importar"(você pode confirmar na próxima tela)',
    ...
    sort: {
        ...
        sortHelp: 'Arraste os diferentes itens para cima ou para baixo para definir como os mesmos serão arranjados. Ou clique no título da coluna para classificar a coleção completa de itens',
    ...
    translation: {
        ...
        noTranslators: 'Nenhum usuário tradutor encontrado. Favor criar um usuário tradutor antes que possa começar a enviar conteúdo para tradução',
        ...
        translationDoneHelp: 'Você pode visualizar as páginas que acaba de traduzir ao clicar abaixo. Se a página original for encontrada você poderá fazer a comparação entre as 2 páginas.',
    ...
    update: {
        ...
        updateNoServerError: 'Erro ao procurar por atualização. Favor revisar os detalhes (stack-trace) para mais informações',
    },
    user: {
        administrators: 'Administrador',
        categoryField: 'Campo de Categoria',
        changePassword: 'Alterar Sua Senha',
        changePasswordDescription: "você pode alterar sua senha para acessar a área administrativa do Umbraco preenchendo o formulário abaixo e clicando no botão 'Alterar Senha'",
