export default {
    ...
    assignDomain: {
        ...
        inherit: 'Nedarv',
        setLanguage: 'Sprog',
        setLanguageHelp: 'Indstil sproget for noder under den aktuelle node,<br /> eller nedarv sprog fra forældre noder. Gælder også<br />\n      for den aktuelle node, medmindre et domæne nedenfor også indstiller et sprog.',
        setDomains: 'Domæner',
    ...
    content: {
        ...
        publishDescendantsHelp: 'Klik <em>Udgiv med undersider</em> for at udgive <strong>%0%</strong> og alle sider under og dermed gøre deres indhold offentligt tilgængelige.',
        publishDescendantsWithVariantsHelp: 'Klik <em>Udgiv med undersider</em> for at udgive <strong>de valgte sprog</strong> og de samme sprog for sider under og dermed gøre deres indhold offentligt tilgængelige.',
        ...
        scheduledPublishDocumentation: '<a href="https://docs.umbraco.com/umbraco-cms/fundamentals/data/scheduled-publishing#timezones" target="_blank" rel="noopener">Hvad betyder det?</a>',
        ...
        languagesToUnpublish: 'Vælg sproget du vil afpublicere. Afpublicering af et obligatorisk sprog vil afpublicere alle sprog.',
    ...
    create: {
        ...
        noDocumentTypes: 'Der kunne ikke findes nogen tilladte dokumenttyper. Du skal tillade disse i indstillinger under <strong>"dokumenttyper"</strong>.',
        ...
        noDocumentTypesAllowedAtRoot: 'Der er ingen tilladte Dokumenttyper tilgængelige for at lave indhold her. Du skal tillade dette i <strong>Dokumenttyper</strong> inde i <strong>Indstillinger</strong> sektionen, ved at ændre <strong>Tillad på rodniveau</strong> indestillingen under <strong>Permissions</strong>.',
        noMediaTypes: 'Der kunne ikke findes nogen tilladte media typer. Du skal tillade disse i indstillinger under <strong>"media typer"</strong>.',
    ...
    defaultdialogs: {
        ...
        regexSearchError: "<a target='_blank' rel='noopener' href='http://regexlib.com'>regexlib.com</a>'s webservice oplever i øjeblikket problemer, vi ikke har kontrol over. Beklager ulejligheden. ",
    ...
    dictionaryItem: {
        description: "Rediger de forskellige sprogversioner for ordbogselementet '%0%' herunder. Du tilføjer flere sprog under 'sprog' i menuen til venstre.",
    ...
    examineManagement: {
        ...
        configuredSearchersDescription: 'Viser egenskaber og værktøjer til enhver konfigureret søger (dvs. som en multi-indekssøger)',
        ...
        manageIndexesDescription: 'Giver dig mulighed for at se detaljerne for hvert indeks og giver nogle værktøjer til styring af indeksørerne',
        rebuildIndex: 'Genopbyg indeks',
        rebuildIndexWarning: 'Dette vil medføre, at indekset genopbygges.<br /> Afhængigt af hvor meget indhold der er på dit website, kan det tage et stykke tid.<br /> Det anbefales ikke at genopbygge et indeks i perioder med høj websitetrafik eller når redaktører redigerer indhold.',
        searchers: 'Søgere',
        ...
        processIsTakingLonger: 'Processen tager længere tid end forventet. Kontrollér Umbraco loggen for at se om der er sket fejl under operationen',
    ...
    editdatatype: {
        ...
        hasReferencesDeleteConsequence: 'Ved sletning af <strong>%0%</strong> fjernes egnskaber og egnskabernes data fra følgende elementer',
    ...
    errors: {
        ...
        externalLoginFailed: 'Serveren mislykkedes i at logge ind med den eksterne loginudbyder. Luk dette vindue og prøv igen.',
    ...
    installer: {
        ...
        databaseInstallDone: 'Umbraco %0% er nu blevet kopieret til din database. Tryk på <string>Næste</strong> for at fortsætte.',
        databaseNotFound: '<p>Databasen er ikke fundet. Kontrollér venligst at informationen i database forbindelsesstrengen i "web.config" filen er korrekt.</p>\n<p>For at fortsætte bedes du venligst rette "web.config" filen (ved at bruge Visual Studio eller dit favoritprogram), scroll til bunden, tilføj forbindelsesstrengen til din database i feltet som hedder "umbracoDbDSN" og gem filen.</p><p>Klik på <strong>Forsøg igen</strong> knappen når du er færdig.<br/><a href="https://our.umbraco.com/documentation/Using-Umbraco/Config-files/webconfig7" target="_blank" rel="noopener">Mere information om at redigere web.config her.</a></p>',
        databaseText: 'For at afslutte dette skridt er du nødt til at have nogle informationer om din database parat ("database forbindelsesstrengen").<br/>Kontakt venligst din ISP hvis det er nødvendigt. Hvis du installerer på en lokal maskine eller server kan du muligvis få informationerne fra din systemadministrator.',
        databaseUpgrade: '<p>Tryk på <strong>Opgradér</strong> knappen for at opgradere din database til Umbraco %0%</p><p>Bare rolig - intet indhold vil blive slettet og alt vil stadig fungere bagefter!</p>',
        databaseUpgradeDone: 'Din database er blevet opgraderet til den endelige version %0%.<br/>Tryk på <strong>Næste</strong> for at fortsætte.',
        databaseUpToDate: 'Din database er up-to-date!. Klik på <strong>Næste</strong> for at fortsætte med konfigurationsguiden.',
        defaultUserChangePass: '<strong>Normalbrugerens adgangskode er nødt til at blive ændret!</strong>',
        defaultUserDisabled: '<p><strong>Normalbrugeren er blevet gjort utjenstdygtig eller har ikke adgang til Umbraco!</strong></p><p>Du behøver ikke foretage yderligere handlinger. Tryk på <strong>Næste</strong> for at fortsætte.</p>',
        defaultUserPassChanged: '<p><strong>Normalbrugerens adgangskode er på succesfuld vis blevet ændret siden installationen!</strong></p><p>Du behøver ikke foretage yderligere handlinger. Tryk på <strong>Næste</strong> for at fortsætte.</p>',
        ...
        permissionsAlmostPerfect: '<strong>Dine rettighedsindstillinger er næsten perfekte!</strong><br/><br/>Du kan køre Umbraco uden problemer, men du vil ikke være i stand til at installere pakker, som er anbefalet for at få fuldt udbytte af Umbraco.',
        permissionsHowtoResolve: 'Hvorledes besluttes',
        permissionsHowtoResolveLink: 'Klik her for at læse tekstversionen',
        permissionsHowtoResolveText: 'Se vores <strong>video tutorials</strong> om at opsætte folderrettigheder for Umbraco eller læs tekstversionen.',
        permissionsMaybeAnIssue: '<strong>Dine rettighedsindstillinger kan være et problem!</strong><br/><br/>Du kan afvikle Umbraco uden problemer, men du vil ikke være i stand til at oprette foldere eller installere pakker, hvilket er anbefalet for at få fuldt udbytte af Umbraco.',
        permissionsNotReady: '<strong>Dine rettighedsindstillinger er ikke klar til Umbraco!</strong><br/><br/>For at afvikle Umbraco er du nødt til at opdatere dine rettighedsindstillinger.',
        permissionsPerfect: '<strong>Dine rettighedsindstillinger er perfekte!</strong><br/><br/>Du er nu parat til at afvikle Umbraco og installere pakker!',
        ...
        theEndBrowseSite: '<h3>Gennemse dit nye site</h3> Du installerede Runway, så hvorfor ikke se hvordan dit nye website ser ud.',
        theEndFurtherHelp: "<h3>Yderligere hjælpe og informationer</h3> Få hjælp fra vores prisvindende fællesskab, gennemse dokumentationen eller se nogle gratis videoer om hvordan du opsætter et simpelt site, hvordan du bruger pakker og en 'quick guide' til Umbraco terminologier",
        theEndHeader: 'Umbraco %0% er installeret og klar til brug',
        theEndInstallFailed: "For at afslutte installationen er du nødt til manuelt at rette <strong>/web.config filen</strong> og opdatére 'AppSetting' feltet <strong>UmbracoConfigurationStatus</strong> i bunden til <strong>'%0%'</strong>.",
        theEndInstallSuccess: 'Du kan <strong>komme igang med det samme</strong> ved at klikke på "Start Umbraco" knappen nedenfor.<br/>Hvis du er <strong>ny med Umbraco</strong>, kan du finde masser af ressourcer på vores \'getting started\' sider.\n',
        theEndOpenUmbraco: "<h3>Start Umbraco</h3>For at administrere dit website skal du blot åbne Umbraco administrationen og begynde at tilføje indhold, opdatere skabelonerne og stylesheets'ene eller tilføje ny funktionalitet.",
        Unavailable: 'Forbindelse til databasen fejlede.',
        Version3: 'Umbraco Version 3',
        Version4: 'Umbraco Version 4',
        watch: 'Se',
        welcomeIntro: 'Denne guide vil bringe dig gennem konfigurationsprocessen af <strong>Umbraco %0%</strong> for en frisk installation eller for en opgradering fra version 3.0.<br/><br/>Tryk på <strong>Næste</strong> for at begynde på guiden.',
    },
    language: {
    ...
    packager: {
        ...
        noPackagesDescription: "Du har ikke nogen pakker installeret. Du kan enten installere en lokal pakke ved at vælge den fra din computer eller gennemse de tilgængelige pakker ved hjælp af ikonet <strong>'Pakker'</strong> øverst til højre på din skærm",
        ...
        packageNoItemsText: 'Denne pakkefil indeholder ingen elementer som kan af-installeres.<br/><br/>Du kan roligt fjerne denne fra systemet ved at klikke på "Fjern pakke" nedenfor.',
    ...
    publish: {
        ...
        publishHelp: 'Klik <em>ok</em> for at udgive <strong>%0%</strong> og derved gøre indholdet offentligt tilgængeligt..<br/><br /> Du kan udgive denne side og dens undersider ved at klikke <em>Udgiv alle undersider</em> forneden',
    ...
    rollback: {
        ...
        diffHelp: 'Her vises forskellene mellem den nuværende version og den valgte version<br /><del>Rød</del> tekst vil ikke blive vist i den valgte version. <ins>Grøn betyder tilføjet</ins>',
    ...
    contentTypeEditor: {
        ...
        allowAtRootDescription: 'Kun dokumenttyper med denne indstilling aktiveret kan oprettes i rodniveau under\n      indhold og mediearkiv.\n    ',
        ...
        isSensitiveDataDescription: 'Skjul værdien af denne egenskab for indholdsredaktører der ikke har adgang til at se følsomme data',
        ...
        historyCleanupGloballyDisabled: '<strong>NOTE!</strong> Oprydning af historiske indholdsversioner er deaktiveret globalt. Disse indstillinger træder først i kraft, når den aktiveres.',
    ...
    user: {
        ...
        createUserHelp: 'Opret nye brugere for at give dem adgang til Umbraco. Når en ny bruger oprettes,\n      genereres der en adgangskode, som du kan dele med brugeren.\n    ',
    ...
    blockEditor: {
        ...
        confirmDeleteBlockGroupMessage: 'Er du sikker på at du vil slette gruppen <strong>%0%</strong> og blok konfigurationer?',
        ...
        gridInlineEditingHelp: 'Tilføjer direkte redigering af det første felt. Yderligere felter optræder kun i redigerings vinduet.',
        ...
        getSampleDescription: 'Dette tilføjer basale og hjælper dig til at komme igang med Block Grid Editor.<br/>Dette indeholder Blokke for Overskrift, Beriget-Tekst, Billede og To-Koloners-Layout.',
        ...
        createThisFor: (name, variantName) => variantName ? `Opret ${name} for ${variantName}` : `Create ${name}`,
        ...
        unsupportedBlockDescription: 'Dette indhold er ikke længere understøttet. Hvis du mangler dette indhold bør du kontakte din administrator. Ellers bør du slette dette indhold.',
    },
    ...
    healthcheck: {
        ...
        clickJackingCheckHeaderNotFound: 'The header or meta-tag <strong>X-Frame-Options</strong> used to control whether a site can be IFRAMEd by another was not found.',
        noSniffCheckHeaderFound: 'The header or meta-tag <strong>X-Content-Type-Options</strong> used to protect against MIME sniffing vulnerabilities was found.',
        noSniffCheckHeaderNotFound: 'The header or meta-tag <strong>X-Content-Type-Options</strong> used to protect against MIME sniffing vulnerabilities was not found.',
        hSTSCheckHeaderFound: 'The header <strong>Strict-Transport-Security</strong>, also known as the HSTS-header, was found.',
    ...
    welcomeDashboard: {
        ...
        ourUmbracoDescription: 'Our Umbraco, den officielle fællesskabsplatform, er dit komplette sted for alt, hvad der vedrører Umbraco. Uanset om du har brug for svar på spørgsmål, spændende tilføjelser eller vejledninger til at udføre noget i Umbraco, er verdens bedste og venligste fællesskab kun et klik væk.',
    ...
    codeEditor: {
        ...
        wordWrapConfigDescription: 'Slå ordbrydning til eller fra, så tekst automatisk brydes ved vinduets kant i stedet for at skabe en horisontal scrollbar.',
    },
    tiptap: {
