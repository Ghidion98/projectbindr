export default {
    ...
    create: {
        ...
        noMediaTypes: 'There are no allowed Media Types available for creating media here. You must enable these in <strong>Media Types Types</strong> within the <strong>Settings</strong> section, by editing the <strong>Allowed child node types</strong> under <strong>Permissions</strong>.',
    ...
    examineManagement: {
        ...
        configuredSearchersDescription: 'Shows properties and tools for any configured Searcher (i.e. such as a multi-index searcher)',
