...
let UmbInstallerLayoutElement = class UmbInstallerLayoutElement extends LitElement {
    render() {
        return html `
			<div id="logo">
...
UmbInstallerLayoutElement = __decorate([
    customElement('umb-installer-layout')
], UmbInstallerLayoutElement);
export { UmbInstallerLayoutElement };
