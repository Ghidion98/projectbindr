...
export const handlers = [
    ...
    rest.get(umbracoPath(`${UMB_SLUG}/current/login-providers`), (_req, res, ctx) => {
    ...
    rest.post(umbracoPath(`${UMB_SLUG}/current/2fa/:providerName`), async (req, res, ctx) => {
    ...
    rest.delete(umbracoPath(`${UMB_SLUG}/current/2fa/:providerName`), (req, res, ctx) => {
